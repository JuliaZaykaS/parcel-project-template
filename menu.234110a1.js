...
(function () {
  ...
  var menuLink = _toConsumableArray(document.querySelectorAll(".menu-item"));
...
$(document).ready(function () {
  $(window).resize(function () {
    ...
    if (windowWidth > 1365) $(".nav.is-open").removeClass("is-open");
    if (windowWidth > 1365) $(".hamburger.is-open").removeClass("is-open");
  });
});
